          ...
          <motion.div
            ...
            <div className='group relative overflow-hidden border-2 border-white/60 rounded-xl '>
              ...
              <div className=' h-font absolute -bottom-full left-12 group-hover:bottom-24
                ...
                <span className='text-gradient text-[2rem]'>UI/UX Design </span>
              </div>
          ...
          <motion.div
            ...
            <div className='group relative overflow-hidden border-2 border-white/60 rounded-xl '>
              ...
              <div className=' h-font absolute -bottom-full left-12 group-hover:bottom-40
                         transition-all duration-500 z-50'>
                <span className='text-gradient text-[2rem]'></span>
              </div>
            ...
            <div className='group relative overflow-hidden border-2 border-white/60 rounded-xl '>
              ...
              <div className=' h-font absolute -bottom-full left-12 group-hover:bottom-24
                         transition-all duration-500 z-50'>
                <span className='text-gradient text-[2rem]'>E-commerce Website </span>
              </div>

              <div className=' h-font absolute -bottom-full left-12 group-hover:bottom-36
                       transition-all duration-700 z-50'>
